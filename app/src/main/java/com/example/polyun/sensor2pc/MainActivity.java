    ...
    private void refreshDisplay() {
        if (acc_disp == true) {
            String output = String.format("Mag: X:%3.2f μT  |  Y:%3.2f μT  |   Z:%3.2f μT \n " +
                            ...
                            "Orient: \n Yaw:%3.2f  |  Roll:%3.2f  |   Pitch:%3.2f \n" +
                            "cOrient: \n Az:%3.2f  |  Roll:%3.2f  |   Pitch:%3.2f \n" +
                            "Rotation Matrix: \n" + rotationMatrix[0],
                    Mag_x, Mag_y, Mag_z,
                    Gx, Gy, Gz,
                    Orient_x, Orient_y, Orient_z,
                    corr_yaw, corr_roll, corr_pitch);
            text.setText(output);
        }
    }
        ...
        public void onSensorChanged(SensorEvent event) {
            ...
            switch (event.sensor.getType()) {
                ...
                case Sensor.TYPE_ORIENTATION:
                     ...
                     */
                    Orient_z = event.values[0];
                    Orient_x = event.values[1];
                    Orient_y = event.values[2];
                    break;
